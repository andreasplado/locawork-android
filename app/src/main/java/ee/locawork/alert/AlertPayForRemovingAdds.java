...
public class AlertPayForRemovingAdds {
    ...
    public static void init(final Activity activity, final Context context) {
        ...
        successTitle.setText(context.getResources().getString(R.string.thank_you_for_your_subscription));
        successText.setText(context.getResources().getString(R.string.you_have_purchased_forever_for_your_subscription_to_see_this_app_without_an_adds));
