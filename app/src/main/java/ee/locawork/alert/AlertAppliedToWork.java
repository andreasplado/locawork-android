...
public class AlertAppliedToWork {
    ...
    public static void init(final Activity activity, final Context context) {
        ...
        successTitle.setText(context.getResources().getString(R.string.you_succesfully_applied_to_the_work));
        successText.setText(context.getResources().getString(R.string.you_have_been_applied_to_work_please_please_wait_for_confirmation));
