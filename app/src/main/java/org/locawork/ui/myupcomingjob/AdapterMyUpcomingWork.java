...
import org.locawork.ui.myupcomingjob.alert.AlertCantGo;
import org.locawork.ui.myupcomingjob.alert.AlertGoToJob;
...
public class AdapterMyUpcomingWork extends RecyclerView.Adapter<AdapterMyUpcomingWork.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cancelJob.setOnClickListener(view -> AlertCantGo.init(context));
